...
<html>
  <head>
    ...
    <title>Login | Cooperative Management System | Staco Insurance | ERP</title>
  ...
  <body class="hold-transition login-page">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <div class="login-logo">
          <a href="index.html"><img src="{{url('/admin/images/logo-w.jpg')}}" alt="" width="225"></a>
        </div>
        <!-- /.login-logo -->
        ...
        <b><a style="font-style: italic;" href="{{ url('/password/reset') }}">Forgot Password?</a></b><br>
    ...
    <!-- jQuery 2.2.0 -->
    <script src="{{url('/admin/css/plugins/jQuery/jQuery-2.2.0.min.js')}}"></script>
    <!-- Bootstrap 3.3.6 -->
