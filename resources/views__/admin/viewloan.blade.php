          ...
          <div class="">
            <div class="page-title">
              ...
              @if ($loan->approval_state == 0)
                <div class="title_right">
                  @if ($loan->stage_id == 4)
                   <a href="{{ url("/loan/disbursement/$loan->loan_id/$loan->stage_id") }}" class="btn btn-success btn-md"><i class="fa fa-folder"></i> Disburse Cash </a> |
                  @else
            ...
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_panel">
                    <div class="x_title">
                      <h2><i class="fa fa-user"></i> Loan Repayment Schedule <!--<small>different form elements</small>--></h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="dropdown">
                    ...
                    <div class="x_content">
                         ...
                         <table class="table table-bordered">
                            <thead>
                              ...
                              <?php $month = 1; ?>
                                 @foreach ($loan->loan->repayments as $repayment)
                                   <tr>
                                    <th scope="row">Month {{ $month++ }}</th>
                                    <th>&#x20A6; {{ number_format($repayment->repayment_amount, 2, '.', ', ') }}</th>
                                    <th>@if ($repayment->payment_status == 1) PAID @else PENDING PAYMENT @endif</th>
                                  </tr>
                                  @endforeach
              ...
              <hr>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-user"></i> Loan Details <!--<small>different form elements</small>--></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
                       ...
                       <table class="table table-bordered">
                          <thead>
                            <tr>
                              ...
                              <th>{{ date("F jS, Y", strtotime($loan->loan->created_at)) }}</th>
                            </tr>
                            <tr>
                              <th scope="row">Loan Amount</th>
                              <th>&#x20A6; {{ number_format($loan->loan->loan_amount, 2, '.', ', ') }}</th>
                            </tr>
                            <tr>
                              <th scope="row">Interest</th>
                              <th>{{ $loan->loan->interest }}</th>
                            </tr>
                            <tr>
                              <th scope="row">Total Payment</th>
                              <th>&#x20A6; {{ number_format($loan->loan->total_payment, 2, '.', ', ') }}</th>
                            </tr>
                            <tr>
                              <th scope="row">Monthly Payment</th>
                              <th>&#x20A6; {{ number_format($loan->loan->monthly_payment, 2, '.', ', ') }}</th>
                            </tr>
                            <tr>
                              <th scope="row">Duration (Months)</th>
                              <th>{{ $loan->loan->duration }}</th>
                            </tr>
                          </thead>
                        </table>
                  </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-user"></i> Loan Application History <!--<small>different form elements</small>--></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-users"></i> Comments <small>Approval/Denial Comments</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
                            ...
                            <tbody>
                              @if (count($loan->loan->comments) != 0)
                                ...
                                <tr>
                                  ...
                                  <th scope="row">{{ $comment->comment }}</td>
                                </tr>
                                @endforeach
                              @endif
                            </tbody>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-user"></i> Place a comment <!--<small>different form elements</small>--></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
