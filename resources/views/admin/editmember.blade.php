          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-user"></i> Member Management <small> Edit member details</small></h3>
              </div>
                          ...
                          <select id="heard" class="form-control" name="bank_name" required>
                            <option value="">Select Bank Name</option>
                              <option value="Access Bank"
                                <?php if($member->bank_name  == "Access Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Access Bank
                              </option>
                              <option value="Aso Savings and Loans"
                                <?php if($member->bank_name  == "Aso Savings and Loans"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Aso Savings and Loans
                              </option>
                              <option value="Citi Bank"
                                <?php if($member->bank_name  == "Citi Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Citi Bank
                              </option>
                              <option value="Diamond Bank"
                                <?php if($member->bank_name  == "Diamond Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Diamond Bank
                              </option>
                              <option value="Ecobank"
                                <?php if($member->bank_name  == "Ecobank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Ecobank
                              </option>
                              <option value="Enterprise Bank"
                                <?php if($member->bank_name  == "Enterprise Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Enterprise Bank
                              </option>
                              <option value="FCMB"
                                <?php if($member->bank_name  == "FCMB"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>FCMB
                              </option>
                              <option value="Fidelity Bank"
                                <?php if($member->bank_name  == "Fidelity Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Fidelity Bank
                              </option>
                              <option value="First Bank"
                                <?php if($member->bank_name  == "First Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>First Bank
                              </option>
                              <option value="GT Bank"
                                <?php if($member->bank_name  == "GT Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>GT Bank
                              </option>
                              <option value="Heritage Bank"
                                <?php if($member->bank_name  == "Heritage Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Heritage Bank
                              </option>
                              <option value="Keystone Bank"
                                <?php if($member->bank_name  == "Keystone Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Keystone Bank
                              </option>
                              <option value="Mainstreet Bank"
                                <?php if($member->bank_name  == "Mainstreet Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Mainstreet Bank
                              </option>
                              <option value="Skye Bank"
                                <?php if($member->bank_name  == "Skye Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Skye Bank
                              </option>
                              <option value="Stanbic IBTC Bank"
                                <?php if($member->bank_name  == "Stanbic IBTC Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Stanbic IBTC Bank
                              </option>
                              <option value="Standard Chatered"
                                <?php if($member->bank_name  == "Standard Chatered"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Standard Chatered
                              </option>
                              <option value="UBA"
                                <?php if($member->bank_name  == "UBA"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>UBA
                              </option>
                              <option value="Union Bank"
                                <?php if($member->bank_name  == "Union Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Union Bank
                              </option>
                              <option value="Unity Bank"
                                <?php if($member->bank_name  == "Unity Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Unity Bank
                              </option>
                              <option value="Wema Bank"
                                <?php if($member->bank_name  == "Wema Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Wema Bank
                              </option>
                              <option value="Zenith Bank"
                                <?php if($member->bank_name  == "Zenith Bank"): ?> 
                                  <?php echo 'selected="True"'; ?>
                                <?php endif; ?>>Zenith Bank
                              </option>
                           </select>
                        </div>
