          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-6 col-xs-12">
                ...
                <div class="x_panel">
                    <div class="x_title">
                      <h2><i class="fa fa-credit-card"></i> Loan Repayment Schedule <!--<small>different form elements</small>--></h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="dropdown">
                              ...
                              <?php $month = 1; ?>
                                 @foreach ($loan->loan->repayments as $repayment)
                                   <tr>
                                    ...
                                    <td>@if ($repayment->payment_status == 1) PAID @else PENDING PAYMENT @endif</td>
                                  </tr>
                                  @endforeach
                            </thead>
                          </table>
              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-credit-card"></i> Loan Details <!--<small>different form elements</small>--></h2>
                  <ul class="nav navbar-right panel_toolbox">
            ...
            <div class="row">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-comments"></i> Comments<small></small></h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <!--<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                        <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i></a>
