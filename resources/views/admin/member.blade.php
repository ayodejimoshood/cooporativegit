          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-money"></i> Financial Information <small>User Records</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
                  ...
                  <div class="col-md-6 col-sm-4 col-xs-12">
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <label style="font-size: 12px;">CURRENT ACCOUNT BALANCE: </label>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <!--<label></label>-->
                      <br>
                      <a style="margin-top: 4px;" href="{{url("/member/payment/$member->user_id")}}" class="btn btn-primary btn-md"> Add New Contribution </a>
                    </div>
                    <div class="x_panel">
                      <div class="x_title">
                        <h2><i class="fa fa-money"></i> Monthly Contribution Schedule<small></small></h2>
                        <ul class="nav navbar-right panel_toolbox">
                      ...
                      <div class="x_content">
                        <table class="table table-bordered">
                          ...
                          @if (count($contributions) != 0)
                            ...
                            <tr>
                              <td scope="row">{{ date("F jS, Y", strtotime($contribution->created_at)) }}</td>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <label style="font-size: 12px;">CURRENT LOAN BALANCE: </label>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        @if ($member->user_id == Auth::user()->user_id)
                          <a style="margin-top: 4px;" href="{{url("/user/loan")}}" class="btn btn-danger btn-md"><i class="fa fa-folder"></i> Apply for a loan</a>
                        @endif
                    </div>
                    <div class="x_panel">
                      <div class="x_title">
                        <h2><i class="fa fa-history"></i> Loan History <!--<small>Bordered table subtitle</small>--></h2>
                        <div class="clearfix"></div>
                      </div>
                      <div class="x_content">
                        <table class="table table-bordered">
                          ...
                          <tbody>
                            @if (count($member->loans) != 0)
                              ...
                              <tr>
                                ...
                                <td>{{ $value->approvals->last()->stage->stage_name }}</td>
                                <td>
                                  @if (count($value->repayments->where('payment_status', 1)->first()) == 0)
                                    &#x20A6; {{ number_format($value->loan_amount, 2, '.', ', ') }}
                                  @else 
                                    &#x20A6; {{ number_format($value->repayments->where('payment_status', 1)->first()->loan_balance, 2, '.', ', ') }}
                                  @endif
                                </td> 
                                <td>
                                  @if (Auth::user()->privilege_id == 3)
                                    <a style="font-size: 10px;" href="{{url("/loan/repayment/$value->loan_id")}}" class="btn btn-danger btn-md"> Add Repayment</a>
                                    @endif
                                </td>
                              </tr>
                              @endforeach
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <label style="font-size: 12px;">CURRENT WITHDRAWAL BALANCE: </label>
                      <input type="text" class="form-control has-feedback-left" id="inputSuccess2" value="&#x20A6; {{ number_format($member->loans->sum('loan_amount'), 2, '.', ', ') }}" disabled="true">
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <!--<label></label>-->
                        <br>
                        @if ($member->user_id == Auth::user()->user_id)
                          <a style="margin-top: 4px;" href="{{url("/user/withdrawal")}}" class="btn btn-success btn-md"><i class="fa fa-folder"></i> Apply for a withdrawal</a>
                        @endif
                    </div>
                    <div class="x_panel">
                      <div class="x_title">
