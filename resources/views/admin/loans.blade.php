          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-history"></i> My Loans <!--<small>Listing design</small>--></h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-history"></i> My Loans <small>View Loans</small></h2>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      @foreach ($loans as $loan)
                        <tr>
                          ...
                          <td>{{ $loan->end_date }}</td>
                          <td>{{ $loan->approvals->last()->stage->stage_name }}</td>
                        </tr>
                      @endforeach 
