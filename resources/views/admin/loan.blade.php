                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="loan-type">Loan Type <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="loan-type" class="select2_single form-control" tabindex="-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          <select name="payment_duration" class="select2_single form-control" tabindex="-1">
                            ...
                            <option value="12">7 Months</option>
                            <option value="24">8 Months</option>
                            <option value="36">9 Months</option>
                            <option value="36">10 Months</option>
                            <option value="36">11 Months</option>
                            <option value="36">12 Months</option>
                            <option value="36">13 Months</option>
                            <option value="36">14 Months</option>
                            <option value="36">15 Months</option>
                            <option value="36">16 Months</option>
                            <option value="36">17 Months</option>
                            <option value="36">18 Months</option>
                            <option value="36">19 Months</option>
                            <option value="36">20 Months</option>
                            <option value="36">21 Months</option>
                            <option value="36">22 Months</option>
                            <option value="36">23 Months</option>
