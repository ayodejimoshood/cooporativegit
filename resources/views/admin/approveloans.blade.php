          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-circle"></i> Approve Loans <!--<small>Listing design</small>--></h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-circle"></i> Approve Loans <small>View Loan Request Approval</small></h2>
