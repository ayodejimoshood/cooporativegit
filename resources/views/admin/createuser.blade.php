                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                      ...
                      <div class="form-group {{ $errors->has('cooperative') ? ' has-error' : '' }} has-feedback">
                        <label for="heard" class="control-label col-md-3 col-sm-3 col-xs-12">Cooperative <span class="required">*</label>
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          <select id="heard" class="form-control" name="cooperative" required>
                            <option value="">Select Cooperative</option>
                            @foreach($cooporatives as $cooporative)
                              <option value="{{ $cooporative->cooporative_id }}">{{ $cooporative->cooporative_name }}</option>
                            @endforeach
                          </select>
                        </div>
                      </div> 
