            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li style="font-size: 11px;"><a href="{{ url('/dashboard') }}"><i class="fa fa-dashboard"></i> DASHBOARD</a></li>
                </ul>
              </div>
                  ...
                  @if (Auth::check())
                    @if (Auth::user()->privilege_id > 1)
                      <li style="font-size: 11px;">
                        <a><i class="fa fa-users"></i> MEMBER MANAGEMENT <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                    ...
                    <li style="font-size: 11px;">
                      ...
                      <ul class="nav child_menu">
                        ...
                        <li><a href="{{ url('/user/payments') }}"><i class="fa fa-building"></i> My approved loans </a>
                        </li>
                      </ul>
                    </li> 
                    ...
                    <li style="font-size: 11px;">
                      ...
                      <ul class="nav child_menu">
                        <li><a href="{{ url('/user/payments') }}"><i class="fa fa-building"></i> View Payments </a></li>
                      </ul>
                    </li> 

                    <li style="font-size: 11px;">
                      <a>
                        <i class="fa fa-steam-square"></i> MY LOANS 
                        <span class="fa fa-chevron-down"></span>
                      </a>
                      <ul class="nav child_menu">
                        <li><a href="{{ url('user/loans') }}"><i class="fa fa-building"></i> View Loans </a></li>
                        <li><a href="{{ url('user/loan') }}"><i class="fa fa-building"></i> Apply for a Loan </a></li>
                      </ul>
                    </li>
