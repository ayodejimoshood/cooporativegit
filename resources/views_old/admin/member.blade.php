                ...
                <div class="x_panel">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" value="{{ $contributions->sum('contribution_amount') }}" disabled="true">
                      </div>  
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <!--<label></label>-->
                        <br>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                       <table class="table table-bordered">
                            ...
                            @if (count($contributions) != 0)
                              ...
                              <tr>
                                <th scope="row">{{ $contribution->created_at }}</th>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" value="400, 000.00" disabled="true">
                      </div>
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <!--<label></label>-->
                        <br>
                        <a href="{{url("/member/loan/$member->user_id")}}" class="btn btn-danger btn-md"><i class="fa fa-folder"></i> Apply for a loan</a>
                      </div>
                    <div class="x_panel">
                      <div class="x_title">
