                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          <select id="heard" class="form-control" name="bank_name" required>
                            <option value="">Select Bank</option>
                              ...
                              <option value="2">Aso Savings and Loans</option>
                              ...
                              <option value="5">FCMB</option>
                              <option value="5">Fidelity Bank</option>
                              <option value="5">First Bank</option>
                              <option value="5">GT Bank</option>
                              <option value="5">Heritage Bank</option>
                              <option value="5">Keystone Bank</option>
                              <option value="5">Mainstreet Bank</option>
                              <option value="5">Skye Bank</option>
                              <option value="5">Stanbic IBTC Bank</option>
                              <option value="5">Standard Chatered</option>
                              <option value="5">UBA</option>
                              <option value="5">Union Bank</option>
                              <option value="5">Unity Bank</option>
                              <option value="5">Wema Bank</option>
