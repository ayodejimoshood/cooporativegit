            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <!--<h3>MENU</h3>-->
                <ul class="nav side-menu" style="font-size: 11px; opacity: 0.9;">
                  <li><a href="{{ url('/dashboard') }}"><i class="fa fa-dashboard"></i> DASHBOARD </a></li>
                </ul>
              </div>
              
              <div class="menu_section">
                <hr style="opacity: 0.2; color: #1773CB; margin-bottom: 13px;">
                <h3 style="font-size: 14px; opacity: 0.9;">MODULES</h3>
                <hr style="opacity: 0.2; margin-top: 13px;">
                <ul class="nav side-menu">
                  ...
                  @if (Auth::check())
                    @if (Auth::user()->privilege_id > 1)
                      <li style="font-size: 11px; opacity: 0.9;">
                        <a>
                      ...
                      <li style="font-size: 11px; opacity: 0.9;">
                        <a>
                          <i class="fa fa-tasks"></i> LOAN MANAGEMENT 
                          <span class="fa fa-chevron-down"></span>
                        </a>
                        <ul class="nav child_menu">
                      ...
                      <li style="font-size: 11px; opacity: 0.9;">
                        ...
                        <ul class="nav child_menu">
                          <li><a href="{{ url('/user/payments') }}"><i class="fa fa-credit-card"></i> View Payments </a></li>
                        </ul>
                      </li>

                      <li style="font-size: 11px; opacity: 0.9;">
                        <a>
                          <i class="fa fa-newspaper-o"></i> MY LOANS
                          <span class="fa fa-chevron-down"></span>
                        </a>
                        <ul class="nav child_menu">
                          <li><a href="{{ url('user/loans') }}"><i class="fa fa-history"></i> View Loans </a></li>
                          <li><a href="{{ url('user/loan') }}"><i class="fa fa-money"></i> Apply For A Loan </a></li>
                        </ul>
                      </li>
