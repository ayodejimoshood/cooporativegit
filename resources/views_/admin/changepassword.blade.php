          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-lock"></i> Change Password <!--<small>Listing design</small>--></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-lock"></i> Change Password <!--<small>different form elements</small>--></h2>
                  ...
                  <div class="x_content">
                    <br />
                      ...
                      <div class="form-group {{ $errors->has('confirm_password') ? ' has-error' : '' }} has-feedback">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12 " for="first-name">Re-type Password <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
