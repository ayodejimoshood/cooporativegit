          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-steam-square"></i> Approve Loans <!--<small>Listing design</small>--></h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-steam-square"></i> Approve Loans <small>View Loans Waiting Approval</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      @foreach ($loans as $loan)
                        <tr>
                          <td>{{ $loan->loan->user->firstname }} {{ $loan->loan->user->lastname }}</td>
                          ...
                          <td>{{ $loan->loan->start_date }}</td>
                          <td>{{ $loan->loan->end_date }}</td>
                          <td></td>
                          <td>{{ $loan->stage->stage_name }}</td>
                           <td>
                            <a href="{{url("/loan/view/$loan->approval_id")}}" class="btn btn-primary btn-xs"> View </a>
                            <!--|
                            <a href="{{url("/user/loan/$loan->loan->loan_id")}}" class="btn btn-success btn-xs"> Approve </a>
                            |
                            <a href="{{url("/user/loan/$loan->loan->loan_id")}}" class="btn btn-danger btn-xs"> Deny </a>-->
                          </td>
