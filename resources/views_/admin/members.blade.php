          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-users"></i> All Members <small>List Of All Members</small></h2>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      @foreach ($members as $member)
                        <tr>
                          ...
                          <td>
                            <a href="{{url("/member/$member->user_id")}}" class="btn btn-primary btn-xs"><i class="fa fa-chevron-circle-right"></i> View </a>
