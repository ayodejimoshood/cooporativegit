          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-user"></i> Financial Information <small>User Records</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <label style="font-size: 12px;"><i class="fa fa-money"></i> CURRENT ACCOUNT BALANCE: </label>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-calendar"></i> Monthly Contribution Schedule<small></small></h2>
                      <ul class="nav navbar-right panel_toolbox">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <label style="font-size: 12px;"><i class="fa fa-money"></i> CURRENT LOAN: </label>
                    ...
                    <div class="x_panel">
                      <div class="x_title">
                        <h2><i class="fa fa-money"></i> Loan Collected <small>Amount Borrowed</small></h2>
                          <!--<ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                            <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i></a>
